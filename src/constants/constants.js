export const projects = [
  ...
  {
    title: "Dugomat",
    description: "Website app used for tracking who you lend your money to, when do they need to return the money, and for what reason they borrowed money. App was made using JS framework Vue, with Firebase API for database and authentication. Currently, available only in Croatian, localization soon",
